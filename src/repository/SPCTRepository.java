...
public class SPCTRepository {
    ...
    public List<SPCTModel> getSearch( String ma, String mavach, String moTa, String soLuong, String tenSp, String tenTH, String tenLTT, String tenKichCo, String mauSac, String chatLieu, String giaNhap, String giaBan, String trangThai) {
        String qery = """
                 SELECT SAN_PHAM_CHI_TIET.[ID]
                                                  ,SAN_PHAM_CHI_TIET.[MA]
                                                  ,[MAVACH]
