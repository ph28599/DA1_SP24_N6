...
public class NhanVienVMRepository {
    ...
    public List<NhanVienVM> getAllNVVM() {
        String sql = "select nv.MA,nv.HOTEN,nv.GIOTINH,nv.SDT,nv.NGAYSINH,nv.DIACHI,nv.EMAIL,nv.CHUCVU,tk.TENDANGNHAP,tk.MATKHAU,nv.TRANGTHAI from NHAN_VIEN nv  join TAI_KHOAN tk on nv.ID = tk.ID_NV";
    ...
    public Integer addNhanVienVM(NhanVienVM nvvm) {
        String sql = "BEGIN TRANSACTION;\n"
                ...
                + "INSERT INTO NHAN_VIEN (MA, HOTEN, GIOTINH,SDT,NGAYSINH,DIACHI,EMAIL,CHUCVU,TRANGTHAI) VALUES (?, ?, ?,?,\n"
                + "?,?,?,?,?);\n"
    ...
    public Integer updateNhanVienVM(NhanVienVM nvvm) {
        String sql = "BEGIN TRANSACTION;\n"
                + "DECLARE @NhanVienID INT;\n"
                + "UPDATE NHAN_VIEN\n"
                + "SET HOTEN = ?, GIOTINH = ?,SDT = ?,NGAYSINH = ?,DIACHI=?,\n"
                + "EMAIL = ?,CHUCVU = ?,TRANGTHAI=?\n"
                + "WHERE MA = ?;\n"
