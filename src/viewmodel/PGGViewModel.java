...
public class PGGViewModel {
    ...
    public PGGViewModel(int id, String ma, String ten, Date ngayBatDau, Date ngayKetThuc, int luotSuDung, String dieuKhoan, Float giaTri, int trangThai) {
        this.id = id;
        this.ma = ma;
        this.ten = ten;
