...
public class HDTableViewModel {
    ...
    public HDTableViewModel() {
    }

    public HDTableViewModel(int id, String ma, String tenNhanVien, String tenKhachHang, String PGG, Date ngayTao, Date ngayThanhToan, int tienGiam, int tongTien, int tienKhachDua, int tienThua, int tienKhachPhaiTra, int HinhThucThanhToan, String maChuyenKhoan, String trangThai) {
        this.id = id;
        this.ma = ma;
    ...
    public Object[] toRowData(){
        return new Object[]{ma,ngayTao,ngayThanhToan,tongTien,tienGiam,tienKhachPhaiTra,trangThai.equals("0")?"Chưa thanh toán":"Đã thanh toán"};
    }
    
    public Object[] toRowDataHD(){
        return new Object[]{ma,ngayTao,tenNhanVien,tenKhachHang};
    }
