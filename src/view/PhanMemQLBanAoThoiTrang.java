 ...
 * @author pc
 */
public class PhanMemQLBanAoThoiTrang extends javax.swing.JFrame {
     ...
     * @param  nv
     */
    public PhanMemQLBanAoThoiTrang(NhanVienVM nv) {
        initComponents();
...
//        setQuyen(nv);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhanMemQLBanAoThoiTrang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
