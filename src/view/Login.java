...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtName.setText("quanly");

        txtPassWorld.setText("12345");
        ...
        jLabel3.setText("CỬA HÀNG ÁO THỜI TRANG ");

        jLabel4.setBackground(new java.awt.Color(153, 102, 255));
        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel4.setText("SHIRT STORE");
        ...
        if (!taiKhoan.equals("") && !matKhau.equals("")) {
            ...
            for (NhanVienVM nvvm : listNhanVien) {
                if (taiKhoan.equalsIgnoreCase(nvvm.getTendn()) &&hashedPassword.equalsIgnoreCase(nvvm.getMatkhau())) {
                    new PhanMemQLBanAoThoiTrang(nvvm).setVisible(true);
                    this.dispose();
                    check = true;
                    break;        
                }
